...
class SmartModelSelector:
    ...
    def __init__(
        ...
        self._selector = ModelSelector(registry=self._registry)
    ...
    def _calculate_score(
        ...
        capability_score = self._selector._get_capability_score(model, task_profile)
        cost_score = self._selector._get_cost_score(model)
        tag_match_score = self._selector._get_tag_match_score(model, task_profile)
